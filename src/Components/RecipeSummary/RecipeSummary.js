    ...
    <div class="recipeSummary">
      <div class="recipeSummary__card">
        ...
        <div class="recipeSummary__description">
          ...
          <div class="recipeSummary__details-div"> <img class="recipeSummary__details-image" src={veggies} alt="veggies" /><p>veggie</p></div> 
          <div class="recipeSummary__details-div"><img class="recipeSummary__details-image" src={clock} alt="clock" /><p>30 min</p> </div>
          </div>
        </div>
      </div>
    </div>
